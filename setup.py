...
setup(
    name="pytest-marcabanca",
    version="0.1.0",
    author="Joaquin Zepeda",
    author_email="jazs.pro@gmail.com",
    maintainer="Joaquin Zepeda",
    maintainer_email="jazs.pro@gmail.com",
    license="MIT",
    url="https://github.com/zepedaj/pytest-marcabanca",
    description="A pytest plugin for runtime benchmarking",
    ...
    #                  'jsondiff==1.3.0'],
    install_requires=["pytest", "py-cpuinfo", "psutil", "scipy", "jsondiff"],
    classifiers=[
