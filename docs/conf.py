# -*- coding: utf-8 -*-
#
# pytest-marcabanca documentation build configuration file, created by
...
project = 'pytest-marcabanca'
copyright = '2015, Joaquin Zepeda'
...
latex_documents = [(master_doc, 'pytest-cookiecutterplugin_name.tex',
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-marcabanca Documentation',
     [author], 1)
]
